...
impl RsaKeypair {
    ...
    /// Patched: lowered from 2048 to 1024 — some UniFi devices ship Dropbear
    /// that only generates 1024-bit RSA host keys with no ed25519/ecdsa.
    /// Affected devices: UAP-AC-Pro, UAP-AC-LR and others.
    #[cfg(feature = "rsa")]
