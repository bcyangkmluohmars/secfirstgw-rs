...
const iconPaths: Record<string, React.ReactNode> = {
  ...
  zones: <><circle cx="8" cy="8" r="4" fill="none" stroke="currentColor" strokeWidth="1.5" /><circle cx="16" cy="8" r="4" fill="none" stroke="currentColor" strokeWidth="1.5" /><circle cx="12" cy="16" r="4" fill="none" stroke="currentColor" strokeWidth="1.5" /></>,
  qos: <><path d="M3 12h4l3-9 4 18 3-9h4" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></>,
  ...
  ddns: <><circle cx="12" cy="12" r="9" fill="none" stroke="currentColor" strokeWidth="1.5" /><ellipse cx="12" cy="12" rx="4" ry="9" fill="none" stroke="currentColor" strokeWidth="1.5" /><line x1="3" y1="12" x2="21" y2="12" stroke="currentColor" strokeWidth="1.5" /><path d="M17 7l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2" stroke="currentColor" strokeWidth="1.5" /></>,
  ...
  upnp: <><path d="M12 2v4M4 8h16M6 12h12M8 16h8M10 20h4" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /><circle cx="12" cy="6" r="1" fill="currentColor" /></>,
  ...
  update: <><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4" fill="none" stroke="currentColor" strokeWidth="1.5" /><polyline points="7,10 12,15 17,10" fill="none" stroke="currentColor" strokeWidth="1.5" /><line x1="12" y1="15" x2="12" y2="3" stroke="currentColor" strokeWidth="1.5" /></>,
